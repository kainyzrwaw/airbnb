...
SELECT listings.property_type, COUNT(reviews.id), MAX(reviews.date_reviewed) FROM reviews INNER JOIN listings ON listings.id = reviews.listing_id GROUP BY listings.property_type;
